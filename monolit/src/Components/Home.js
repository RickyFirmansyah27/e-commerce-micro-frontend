        ...
        <div className="mx-auto container flex justify-center items-center py-12 px-4 sm:px-6 2xl:px-0">
            <div className="flex flex-col lg:flex-row justify-center items-center space-y-6 lg:space-y-0">
                <div className="w-80 sm:w-auto flex flex-col justify-start items-start">
                    <div>
                        <p className="text-3xl xl:text-4xl font-semibold leading-9 text-gray-800 dark:text-black">
                            International Ecommerce, We Are Here
                        </p>
                    </div>
                    <div className="mt-4 lg:w-4/5 xl:w-3/5">
                        <p className="text-base leading-6 text-gray-600 dark:text-black">
                            Same tech for less Save by shopping on Shop.
                        </p>
                    </div>
              ...
              <button className="px-4 bg-green-400 rounded-md dark:bg-white dark:text-gray-900 dark:hover:scale-105  flex justify-between items-center w-full lg:w-72 h-14 text-white focus:ring-2 outline-none  focus:ring-offset-2  dark:hover:bg-gray-100">
                <p className="text-xl font-medium leading-5 bg-green-400 py-3 px-5 text-white rounded-lg hover:shadow-lg transition duration-3000 cursor-pointer">
                  See More
                </p>
                <svg
                ...
                <div className="flex flex-col sm:flex-row jusitfy-center items-center sm:space-x-5 xl:space-x-8 space-y-4 sm:space-y-0">
                    <div className="">
                        <img
                            ...
                            src="https://m.media-amazon.com/images/I/71x7+zZCNBL._SL1500_.jpg"
                            alt="sofa"
                        />
                    </div>
                    <div className="flex flex-col justify-center items-center space-y-4 sm:space-y-0 sm:space-y-5 lg:space-y-5 xl:space-y-8">
                        <div>
                            <img
                                className="hidden lg:block"
                                src="https://media.istockphoto.com/id/860853894/photo/red-headphones-isolated-on-a-white-background.jpg?s=612x612&w=0&k=20&c=qNtAs69Yalkq__YfZp2gu8w2mEcw0ssTnY6L-4mFWRI="
                                alt="headphone"
                            />
                        </div>
                        <div>
                            <img
                                className="hidden lg:block"
                                src="https://dlcdnwebimgs.asus.com/gain/5183d61e-e9fe-4734-8270-d937a0cafc8d/"
                                alt="laptop"
